<template lang='haml'>
  .column.column-main-body
    ...
    .documentation-body
      ...
      %p
        When a new facility is built, the game will automatically list all the warehouses set in Export mode as
        suppliers. See
      ...
      %p.content
        %ol
          ...
          %li
            Click on the
            %i Hire
            &nbsp;button. The Supplies Search Page will appear, now you can set the options you want
            in order to narrow your search. Press the
            %i Search
